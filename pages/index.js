      ...
      <div className="grid lg:grid-cols-[70%_30%] md:grid-cols-2 md:h-[80vh] overflow-hidden">
        <div className="lg:px-20 md:py-6 relative">
          ...
          <div
            ...
            className={`bg-yellow-1 mb-4 mx-6 md:hidden z-50 backButton relative group hover:cursor-pointer  transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#977c6d] flex justify-center items-center space-x-3 font-roboto rounded-md py-2.5 md:w-32 w-10 text-white text-center`}>
          ...
          <div
            ...
            } backButton group hover:cursor-pointer  transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#977c6d] flex justify-center items-center space-x-3 font-roboto rounded-md py-2.5 md:w-32 w-10 text-white text-center`}>
