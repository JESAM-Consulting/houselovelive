      ...
      <div className="md:my-8 my-4">
        <div className="flex">
          <div
            ...
            className="bg-yellow-1 px-5 py-3 rounded-md hover:cursor-pointer text-white transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#93796b] font-bold lg:text-base text-sm">
